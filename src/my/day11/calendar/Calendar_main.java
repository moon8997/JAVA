...
public class Calendar_main {
	...
	public static void main(String[] args) {
	   ...
	   */
	   ...
	   System.out.println("올 해의 년도 : " + year); // 2021
	    System.out.println("월(0~11, 0:1월): " + strMonth); // 11
	    System.out.println("월(1~12, 1:1월): " + strMonth2); // 12
