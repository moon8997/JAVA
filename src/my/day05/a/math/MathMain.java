...
public class MathMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n=== 소수점 첫째 자리까지 나타내면서 반올림 한 후 ===");	
		 // 1) 93.45678 >> 934.5678 / 2) Math.round(934.5678) >> 935 >> 93.5
		System.out.println("db1 => " + Math.round(db1*10)/10.0 + ", db2 => " + Math.round(db2*10)/10.0);
		
		System.out.println("\n=== 소수점 두째 자리까지 나타내면서 반올림 한 후 ===");
		System.out.println("db1 => " + Math.round(db1*100)/100.0 + ", db2 => " + Math.round(db2*100)/100.0);
		 // 1) 86.87654 >> 8687.654 / 2) Math.round(8687.654) >> 8688 >> 86.88
